...
export namespace MechDataQuirkData {
  ...
  export var QuirkTranslatedNameMap: { [index: string]: QuirkNameEntry } = {
    ...
    "atm_heat_multiplier": { name: "atm_heat_multiplier", translated_name: "ATM HEAT" },
    ...
    "clanlaser_duration_multiplier": { name: "clanlaser_duration_multiplier", translated_name: "Clan Laser Cooldown" },
    ...
    "clanmediumpulselaser_range_multiplier": { name: "clanmediumpulselaser_range_multiplier", translated_name: "Clan Medium Pulse Laser Range" },
    "clannarcbeacon_range_additive": { name: "clannarcbeacon_range_additive", translated_name: "NARC BEACON RANGE" },
    "clanppc_velocity_multiplier": { name: "clanppc_velocity_multiplier", translated_name: "Clan PPC Velocity" },
    "clanpulselaser_heat_multiplier": { name: "clanpulselaser_heat_multiplier", translated_name: "Clan Pulse Laser Heat" },
    ...
    "heavylaser_duration_multiplier": { name: "heavylaser_duration_multiplier", translated_name: "Heavy Laser Duration" },
    "heavylaser_heat_multiplier": { name: "heavylaser_heat_multiplier", translated_name: "Heavy Laser Heat" },
    "heavylaser_range_multiplier": { name: "heavylaser_range_multiplier", translated_name: "Heavy Laser Range" },
    ...
    "turnrate_multiplier": { name: "turnrate_multiplier", translated_name: "TURN RATE" },
    ...
    "ultraautocannon20_jamchance_multiplier": { name: "ultraautocannon20_jamchance_multiplier", translated_name: "UAC/20 JAM CHANCE" },
